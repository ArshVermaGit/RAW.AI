    ...
    <Modal isOpen={isOpen} onClose={onClose} className="max-w-4xl w-full bg-[#050505]/95 border-white/5 p-0 overflow-visible backdrop-blur-xl">
      <div className="relative p-8 md:p-12 overflow-hidden">
        ...
        <div className="text-center mb-10">
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/20 text-[10px] font-bold uppercase tracking-[0.3em] text-purple-400 mb-6"
            >
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
                <div className="flex items-baseline gap-2">
                    <span className="text-6xl font-display font-black text-white tracking-tighter">$10</span>
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-white/40 text-sm mb-8">Unleash the full power of RAW.AI.</p>
