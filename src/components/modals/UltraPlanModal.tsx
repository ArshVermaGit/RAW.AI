    ...
    <Modal isOpen={isOpen} onClose={onClose} className="max-w-4xl w-full bg-[#050505]/95 border-white/5 p-0 overflow-hidden backdrop-blur-xl my-4">
      <div className="relative p-6 md:p-12 overflow-y-auto max-h-[85vh] scrollbar-thin scrollbar-track-transparent scrollbar-thumb-white/10">
        ...
        <div className="text-center mb-8 md:mb-10">
            ...
            className="inline-flex items-center gap-2 px-3 py-1 md:px-4 md:py-1.5 rounded-full bg-purple-500/10 border border-purple-500/20 text-[10px] font-bold uppercase tracking-[0.3em] text-purple-400 mb-4 md:mb-6"
            >
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
                <div className="flex items-baseline gap-2 justify-center md:justify-start">
                    <span className="text-5xl md:text-6xl font-display font-black text-white tracking-tighter">$10</span>
                    <div className="flex flex-col text-left">
                        <span className="text-lg line-through text-white/20 font-bold decoration-purple-500/40 leading-none mb-1">$20</span>
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8 flex flex-col items-center justify-center text-center">
                <h3 className="text-xl font-bold text-white mb-2">Maximum Potential</h3>
                <p className="text-white/40 text-sm mb-6 md:mb-8">Unleash the full power of RAW.AI.</p>
